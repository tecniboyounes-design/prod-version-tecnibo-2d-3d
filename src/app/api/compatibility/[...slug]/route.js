...
import { getCorsHeaders } from "@/lib/cors"; // 4 levels up from this file

const TARGET_BASE = "http://192.168.30.92:4444/compatibility";
...
export async function POST(req, { params }) {
  ...
  try {
    ...
    const targetUrl = `${TARGET_BASE}${slugPath}`;
    console.log("➡️ Forward →", targetUrl);
