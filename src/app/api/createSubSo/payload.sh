...
curl -sS -X POST "http://192.168.30.92:3009/api/createSubSo" \
  -H "Content-Type: application/json" \
  -H "X-Session-Id: 7185f5c4fc7893b87de3b0cedf21ba9109bcac25" \
  --data-binary @- <<'JSON' | jq .
      ...
      "vendors": [
        {
          ...
          "product_tmpl_id": [
            1000020,
            "[00481147] Set de 2 charnières pour réfrigérateur et congélateur"
          ],
          "product_id": null,
          "min_qty": 0,
          "price": 0,
      ...
      "vendors": [
        {
          ...
          "product_tmpl_id": [
            998599,
            "[00492680] Charnière Siemens pour réfrigérateur encastrable"
          ],
          "product_id": null,
          "min_qty": 0,
          "price": 0,
