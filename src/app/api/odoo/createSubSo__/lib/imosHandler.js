...
const IMOS_OUTPUT_DIR = process.env.IMOS_OUTPUT_DIR || path.resolve(process.cwd(), "imos_output");
...
export async function handleImosItems(imosItems, context = {}) {
    ...
    const RECEIVER_URL = process.env.IMOS_RECEIVER_URL || "http://192.168.30.41:3500/imos/receive";
