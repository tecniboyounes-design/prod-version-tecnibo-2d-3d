...
//             {
//                 "locked": false,
//                 "name": "Project Name - Test #Order - Status - Next Steps Next.js server V 14.3.0 ",
//                 "partner_id": 17085,
...
//                 "date_order": "2025-02-13 13:28:58",
...
//                             "phase_id": false,
//                             "name": "otman next.js TEST #1 IS DONE. NOW NEXT.JS next: ^14.2.16  Test #1 ",
//                             "section_id": false,
//                             "cr_id": false,
//                             "product_template_id": 867535,
 ...
 * @returns {string} - Constructed payload for the Odoo API as a JSON string
 */
export function createOrderPayload(items, orderName) {
    ...
    const orderLine = items.map((item, index) => [
        0,
        "virtual_" + (index + 9), // Ensure virtual index matches reference
        {
            display_type: false,
            sequence: 10, // Match reference static value
            product_id: item?.id ?? 875586, // Match fallback reference ID
            product_uom_qty: item?.quantity ?? 0, // Match reference quantity default
            move_ids: [],
            product_uom: 1,
            qty_delivered: 0,
            product_packaging_qty: 0,
            ...
            advance_payment_pct: 0,
            is_delivery: false,
            price_unit: item?.price ?? 5310.231000000001, // Match reference price
            purchase_price: 0,
            analytic_line_type_id: 5,
            tax_id: [],
            discount: 0,
            ...
            section_product_id: false,
            phase_id: false,
            name: item?.attributes?.name ?? "otman CLI Test #1 product test #1",
            section_id: false,
            cr_id: false,
            product_template_id: item?.product_template_id ?? 867535, // Match reference template ID
            product_custom_attribute_value_ids: [],
            product_no_variant_attribute_value_ids: [],
            price_unitre: 0 // Explicitly set to 0 to match reference
        }
    ]);
        ...
        params: {
            ...
            args: [
                [], 
                {
                    ...
                    //             "section_product_id": false,
                    //             "phase_id": false,
                    //             "name": "otman  CLI Test #1 product test #1",
                    //             "section_id": false,
                    //             "cr_id": false,
                    //             "product_template_id": 867535,
                    //             "product_custom_attribute_value_ids": [],
