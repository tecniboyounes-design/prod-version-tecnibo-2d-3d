...
const ProjectInfoBar = () => {
  ...
  return (
    <>
        ...
        >
          <Box sx={{ display: "flex", flexDirection: "column" }}>
            ...
            >
              ...
              <StatusChip
                status={
                  selectedProject?.status || selectedProject?.rating_status
                }
              />
            </Box>
            ...
            >
              ...
              >
                ...
                <PeopleAlt
                  sx={{ fontSize: 18, color: "gray", marginRight: 1 }}
                />
                ...
                >
                  ...
                  >
                    Manager
                    {selectedProject?.managers?.length > 1 ? "(s)" : ""}:
                  </Typography>
                  ...
                  {selectedProject?.managers?.length > 3 && (
                    <Tooltip
                      title={selectedProject?.managers
                        ?.map((m) => m.name)
                        .join(", ")}
                      arrow
                    >
      ...
      {typeof window !== "undefined" && !pathname.includes("/configurator") && (
        <LinearBuffer />
      )}
    </>
  );
